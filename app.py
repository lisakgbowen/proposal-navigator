...
if run_review:
    ...
    st.markdown("#### Funding Opportunity Source Findings")
    ...
    for item, answer in responses.items():
        ...
        with st.expander(label):
            if match["found"]:
                ...
                st.markdown("**Relevant source excerpt**")
    ...
    st.markdown(
        ...
        <div class="pn-section">
            <div class="pn-section-head">
                ...
                <span class="pn-section-title">Items Requiring Human Review</span>
            </div>
        </div>
        """,
        unsafe_allow_html=True
    ...
    st.markdown(
        """
        <div class="pn-note">
            <strong>Important:</strong> Proposal Navigator is a decision-support prototype.
            It does not replace sponsor guidance, institutional policy, or Research Administration review.
        </div>
        """,
        unsafe_allow_html=True
    )
