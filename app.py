...
if st.button("Run Readiness Review"):
    ...
    for item, answer in responses.items():
        ...
        with st.expander(
            ...
            if match["found"]:
                ...
                with st.spinner("Interpreting sponsor language..."):
                    interpretation = interpret_source_with_ai(
                        item,
                        answer,
                        match
                    )
            ...
            st.caption(
                "The source text was retrieved from the uploaded funding opportunity "
                "and interpreted by generative AI when a source match was found. "
                "Human review is still required for final proposal decisions."
            )
    ...
    st.info(
        "This v0 connects user intake with page-level source language from the "
        "uploaded funding opportunity and uses generative AI to interpret matched "
        "source excerpts. Final proposal decisions still require human review."
    )
